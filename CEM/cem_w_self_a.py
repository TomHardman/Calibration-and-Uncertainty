...
class ConfidenceModelAttn(nn.Module):
    # apply attention to logits, followed by some fully connected layer
    def __init__(self, max_len = 128, label_len = 768, qkv_len = 768, dropout=0.2):  # embedding length uncertain
        ...
        # self.query = nn.Linear(self.label_len, self.qkv_len)
        # self.key = nn.Linear(self.label_len, self.qkv_len)
        # self.value = nn.Linear(self.label_len, self.qkv_len)
        self.value = nn.Sequential(
            nn.Linear(self.label_len, self.qkv_len),
            nn.ReLU(),
            # nn.Dropout(p=self.dp_p),
        )
...
def main(args):
    ...
    train_file = [ '/home/alta/BLTSpeaking/exp-zl437/demo/gector/CEM/data/self_attn/train.npy',
                  '/home/alta/BLTSpeaking/exp-zl437/demo/gector/CEM/data/self_attn/train_45_0.npy',
                  '/home/alta/BLTSpeaking/exp-zl437/demo/gector/CEM/data/self_attn/train_45_1.npy',]
    ...
    criterion = nn.BCELoss().to(device)
    optimizer = optim.Adam(confidence_model.parameters(), lr=1e-5, weight_decay=1e-05, betas=(0.9, 0.98), eps=1e-9)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path',
                        ...
                        default='/home/alta/BLTSpeaking/exp-zl437/demo/gector/CEM/model/selfAttnMask/model1.pt'
                        )
